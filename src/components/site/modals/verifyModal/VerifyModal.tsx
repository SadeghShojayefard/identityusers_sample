...
import { verifyPhoneAction } from "@/identityuser/helper/signInAction";
...
export default function VerifyModal({ showOtpModal, expiresAt, phoneNumber }: OtpModalProps) {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="sm:max-w-[425px] max-h-[95vh] overflow-auto bg-white ">
                ...
                <form id={form.id} onSubmit={form.onSubmit} action={formAction} className="flex flex-col w-full mt-5">
                    ...
                    {
                        lastResult?.status === "success" && hasPayload(lastResult) &&
